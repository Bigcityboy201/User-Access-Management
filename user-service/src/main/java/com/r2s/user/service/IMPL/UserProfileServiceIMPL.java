...
public class UserProfileServiceIMPL implements UserProfileService {
    ...
    public void create(CreateUserProfileDTO dto) {
        log.info("Creating user profile: username={}, email={}, fullName={}, roleNames={}", 
                dto.getUsername(), dto.getEmail(), dto.getFullName(), dto.getRoleNames());
        ...
        log.info("User profile created successfully with ID: {} for username: {} with roles: {}", 
